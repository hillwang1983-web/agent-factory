        ...
        <>
          ...
          {isIntakeWizardOpen && (
            <div
              ...
              onKeyDown={e => e.key === 'Escape' && setIsIntakeWizardOpen(false)}
            >
              <div className="bg-slate-900 rounded-2xl border border-slate-800 w-[800px] max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col">
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 shrink-0">
                  <span className="text-sm font-medium text-gray-300">从原始需求建 ADU — {currentProject.name}</span>
                  <button
                    onClick={() => setIsIntakeWizardOpen(false)}
